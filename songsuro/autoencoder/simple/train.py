...
from songsuro.autoencoder.simple.models import SimpleAutoencoder
...
def train(
	...
	if not os.path.isdir(checkpoint_path):
		model = SimpleAutoencoder.load_from_checkpoint(checkpoint_path)
	...
	wandb_logger = WandbLogger(
		name=str(datetime.now()), project="Songsuro-simple-autoencoder"
	)
