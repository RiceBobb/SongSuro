...
from songsuro.modules.commons.layers import LayerNorm, Embedding
...
class ResidualBlock(nn.Module):
	...
	def __init__(
		...
		if norm_type == "bn":
			norm_builder = bn_builder
		elif norm_type == "in":
			norm_builder = in_builder
		elif norm_type == "gn":
			norm_builder = gn_builder
		elif norm_type == "ln":
			norm_builder = ln_builder
		else:
			norm_builder = identity_builder
